...
tk_barrydegraaff_zimbra_openpgp.prototype.lang = function () {
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['english'][55] = '';
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['dutch'][55] = '';   
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['spanish'][55] = '';
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['italian'][55] = '';
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['vietnamese'][55] = '';
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['portuguese_brazil'][55] = '';
   ...
   tk_barrydegraaff_zimbra_openpgp.lang['français'] = [];
   tk_barrydegraaff_zimbra_openpgp.lang['français'][0] = 'OpenPGP est une extension pour Zimbra Collaboration Suite.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][1] = 'Signer le message';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][2] = 'Crypter le message';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][3] = 'Gérer les clés';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][4] = 'Générer une paire de clés';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][5] = 'Aide / A propos ';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][6] = "Le chargement des contacts continu, en ignorant votre carnet d'adresse";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][7] = 'Ne peux pas lire ce message crypter!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][8] = 'Entrer votre clé privée et votre phrase pour le décryptage';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][9] = 'Fermer';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][10] = 'Version';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][11] = 'Aide';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][12] = 'pas de message PGP détecter';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][13] = "Impossible d'analyser la clé public de confiance!";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][14] = "C'est une bonne signature";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][15] = "C'est une mauvaise signature";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][16] = 'Message ';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][17] = 'Erreur en vérifiant la signature';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][18] = "Votre clé privée restera en mémoire jusqu'à ce que vous rechargiez votre navigateur.";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][19] = 'Clé privée';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][20] = 'Phrase';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][21] = 'Message';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][22] = "<li>Commencer par copier/coller votre clé . </li><li> Vous pouvez aussi ajouter votre clé dans le champ Notes de votre fiche contact dans votre carnet d'adresse.</li><li> Vous pouvez aussi mettre des commentaires pour chaque clés du moment que vous commencez une nouvelle ligne pour une clé publique.</li>";   
   tk_barrydegraaff_zimbra_openpgp.lang['français'][23] = 'Langue';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][24] = 'Si vous sauvegarder votre phrase , celle ci sera conserver sur le serveur en clair . Si vous voulez plus de sécurité ne la sauvegarder pas , celle ci vous sera demandé à chaque fois.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][25] = 'Si vous décider de sauvegarder votre clé privé ci-dessous, cette dernière sera stocké dans votre navigateur <a href=\"http://diveintohtml5.info/storage.html\" target=\"_blank\" >local storage</a> en utilisant le systme de cryptage  AES-256. Dans le cas contraire, la clé privé vous sera demandé à chaque session.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][26] = 'Clé public';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][27] = 'Scan des contacts';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][28] = "Ecrivez d'abord votre message avant de le signer avec votre clé privée.";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][29] = "Entrer votre nom d'utilisateur (Exemple : Prenom Nom &lt;votre@email.com&gt;)et votre phrase pour la nouvelle paire de clés.";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][30] = "Nom d'utilisateur";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][31] = 'Longueur de la clé';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][32] = "Plus c'est long, plus c'est bon.";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][33] = 'Remplacer et enregistrer votre clé privé actuelle, la passphrase et la clé publique 1.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][34] = 'Générer une pĥrase';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][35] = 'Destinataire';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][36] = "Veuillez composer le message ci-dessous afin qu'il soit crypté. Pour les nouveaux utilisateurs, vous pouvez lire le";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][37] = 'Optionnel : Signer votre message crypter avec votre clé privée et votre phrase.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][38] = 'Impossible de lire la clé privée!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][39] = "n'est pas signé";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][40] = 'Pièce jointe ';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][41] = 'Décrypter le message';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][42] = 'message original';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][43] = 'Echec du décryptage!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][44] = 'Mauvaise Phrase!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][45] = 'Impossible de signer!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][46] = "Vous devez fournir un nom d'utilisateur et une phrase";
   tk_barrydegraaff_zimbra_openpgp.lang['français'][47] = 'Génération de votre paire de clés';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][48] = 'La génération de la clé peux prendre du temps veillez patienter.<br><br>Si vous avez des problèmes avec la génération de la paire de clé, choissisez un encryptage moins fort.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][49] = 'Stocker ces informations dans un endroit sur et ne les perder pas';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][50] = 'Votre nouvelle paire de clés';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][51] = 'Selectionner le(s) destinataire(s).';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][52] = 'Impossible de crypter le message!';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][53] = 'avec OpenPGP';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][54] = 'Désactiver votre signature';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][55] = 'Veuillez nous execuser, la Zimlet OpenPGP ne fonctionne pas correctement avec les signatures sous format HTML. Merci de les désactiver pour crypter/signer votre mail';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][56] = 'Veuillez écrire votre message avant';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][57] = 'OpenPGP a fini de scanner vos contacts';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][58] = 'OpenPGP scan vos contacts';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][59] = 'Crypter le fichier';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][60] = 'Decrypter le fichier';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][61] = 'Veillez selectionner le fichier à crypter.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][62] = 'Optionnel : signer votre fichier crypter en entrant votre phrase et votre clé privée.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][63] = 'Veillez selectionner le fichier à décrypter.';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][64] = 'Décryter en utilisant';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][65] = 'Fichier';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][66] = 'Décryptage automatique';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][67] = 'Effacer toutes les clés public (crée un nouveau mot de passe de type AES)';
   tk_barrydegraaff_zimbra_openpgp.lang['français'][68] = 'ZmSetting MAX_MESSAGE_SIZE'; 
   tk_barrydegraaff_zimbra_openpgp.lang['english'][69] = 'Parametre avancé';
   tk_barrydegraaff_zimbra_openpgp.lang['english'][70] = 'Passer en texte brut et réessayer.';
