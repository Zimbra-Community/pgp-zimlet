...
function(itemId) {
	...
	case "keypair":
      this.displayDialog(5, "Generate new key pair", null);
		break;
	case "about":
      this.displayDialog(2, "About OpenPGP", '<h1><span style="font-family: sans-serif;">Zimbra OpenPGP Zimlet ' + this._zimletContext.version + '</span></h1>Running in Internet Explorer mode for Zimbra < 8.5 : ' + this.isIE + '<br><br><span style="font-family: sans-serif;">If you find Zimbra OpenPGP Zimlet useful and want to support its continued development, you can make a </span><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&amp;business=info%40barrydegraaff%2etk&amp;lc=US&amp;item_name=Zimbra%20OpenPGP%20Zimlet&amp;no_note=0&amp;currency_code=EUR&amp;bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHostedGuest"><span style="font-family: sans-serif;">donation</span></a><span style="font-family: sans-serif;">. Please report <a href="https://github.com/barrydegraaff/pgp-zimlet/issues">bugs</a></span><span style="font-family: sans-serif;"> on Github.</span><br><br><span style="font-family: sans-serif; font-weight: bold;">Credits</span><br><ul><li><span style="font-family: sans-serif;"><a href="http://www.premierheart.com/">Michael Graziano</a> <small>enhancements</small></span></li><li><span style="font-family: sans-serif;"><a href="http://www.onecentral.nl">Marius Savelbergh</a> <small>funds</small></span></li><li><span style="font-family: sans-serif;"><a href="http://www.profluid.de/">Klaus Belser</a> <small>funds</small></span></li><li><span style="font-family: sans-serif;"><a href="http://www.hivos.org">Hivos.org</a> <small>funds</small></span></li><li><span style="font-family: sans-serif;"><a href="http://openpgpjs.org/">OpenPGP.js</a><small></small></span></li><li><span style="font-family: sans-serif;"><small>and others.<br></small></span></li></ul><span style="font-family: sans-serif;"></span><span style="font-family: sans-serif;">Copyright (C) 2014&nbsp; Barryde Graaff </span><br style="font-family: sans-serif;"><br><span style="font-family: sans-serif;">This program is free software:you can redistribute it and/or modify</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">it under the terms of the GNUGeneral Public License as published by</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">the Free Software Foundation,either version 3 of the License, or</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">(at your option) any laterversion.</span><br style="font-family: sans-serif;"><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">This program is distributed inthe hope that it will be useful,</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">but WITHOUT ANY WARRANTY;without even the implied warranty of</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">MERCHANTABILITY or FITNESS FOR APARTICULAR PURPOSE.&nbsp; See the</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">GNU General Public License formore details.</span><br style="font-family: sans-serif;"><br style="font-family: sans-serif;"><span style="font-family: sans-serif;">You should have received a copyof the GNU General Public License</span><brstyle="font-family: sans-serif;"><span style="font-family: sans-serif;">along with this program.&nbsp;If not, see <a href="http://www.gnu.org/licenses/">http://www.gnu.org/licenses/</a>.</span><br><br>');
		break;
   }
};
...
function(id, title, message) {
   ...
   case 3:
      ...
      "</td></tr>" +
      "<tr><td style=\"width:100px\">Private Key:</td><td style=\"width:500px\"><textarea class=\"barrydegraaff_zimbra_openpgp-input\" rows=\"3\" cols=\"65\" id='privateKeyInput'/>" + this.getUserPropertyInfo("zimbra_openpgp_privatekey").value + "</textarea><b>Storing Private Key here is STRONGLY DISCOURAGED!</b></td></tr>" +
      "<tr><td>Passphrase:</td><td><input class=\"barrydegraaff_zimbra_openpgp-input\" id='privatePassInput' type='password' value='" + this.getUserPropertyInfo("zimbra_openpgp_privatepass").value + "'><b>Storing Passphrase here is STRONGLY DISCOURAGED!</b></td></tr>" +
