...
If you can use your keyserver from a browser, but not from the Zimlet, you may need to enable CORS. See: http://enable-cors.org/server.html and https://github.com/Zimbra-Community/pgp-zimlet/issues/205
